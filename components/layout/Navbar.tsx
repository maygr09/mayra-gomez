...
const navLinkClassName =
  "relative pb-1 transition-colors duration-200 hover:text-lavender-600 after:absolute after:bottom-0 after:left-0 after:h-px after:w-0 after:bg-lavender-600 after:transition-all after:duration-200 hover:after:w-full";
